...
echo "$($PSQL "select distinct(name) from teams inner join games on team_id = winner_id or team_id = opponent_id \
where year = 2014 and round = 'Eighth-Final' order by name")"
